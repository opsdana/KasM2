-- =============================================
-- MIGRASI: Update pg_cron → notif-wa-gateway
-- Sebelumnya semua cron mengarah ke notif-fonnte,
-- sekarang diarahkan ke notif-wa-gateway (WA Gateway)
-- Date: 2026-06-29
-- =============================================
...
-- daily-perkiraan-h1: 00:00 UTC = 07:00 WIB, Senin-Jumat
-- → "SUMMARY KEBUTUHAN BON HARI INI"
...
-- daily-laporan-ht: 09:00 UTC = 16:00 WIB, Senin-Jumat
SELECT cron.schedule(
  'daily-laporan-ht',
  '0 9 * * 1-5',
  $$
